<template>
  <div id="shopping-cart">
    ...
    <div v-if="!cart" id="empty-cart">El carro está vacío.</div>
    <div v-else id="cart">
      <div id="detail">
        <DesktopCart
      ...
      cart: [
        {
          ...
          category: "Camisetas",
          image:
            "https://contents.mediadecathlon.com/p1594532/k$5242b7ab6707052de43a6c0dd0a50c53/camiseta-regular-100-algodon-sportee-100-gimnasia-stretching-hombre-blanco.jpg?format=auto&f=800x800",
          price: 50000,
          quantity: 2,
          size: "L",
          sizes: ["S", "M", "L"],
